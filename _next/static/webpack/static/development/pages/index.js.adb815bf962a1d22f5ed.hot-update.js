...
var renderActiveShape = function renderActiveShape(props) {
  ...
  var type = payload.name.split(" ").join("\n");
  return __jsx("g", {
    __self: _this2,
    __source: {
      fileName: _jsxFileName,
  ...
  }, type), __jsx(recharts__WEBPACK_IMPORTED_MODULE_9__["Sector"], {
    cx: cx,
    cy: cy,
...
//# sourceMappingURL=index.js.adb815bf962a1d22f5ed.hot-update.js.map